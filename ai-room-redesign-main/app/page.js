...
and Home
    ...
    <div className="mt-8 gap-3 flex justify-center">
      ...
      <Link className="inline-flex justify-center items-center
      gap-x-3 text-center bg-white border border-gray-200
       hover:bg-gray-50 text-gray-800 text-sm font-medium rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 py-3 px-4 dark:bg-neutral-800 dark:border-neutral-700 dark:hover:bg-neutral-700 dark:text-neutral-200"
       href="/sign-in">
        Sign in
      </Link>
    </div>
